...
function checkContent() {
	...
	return true;
  	...
  	<div class="container">
        ...
        <form action="${pageContext.request.contextPath}/community/admin/Enroll.do?${_csrf.parameterName}=${_csrf.token}"
          ...
          <div class="board-footer">
            <!-- 관리자-->
            <button type="reset" class="btn btn-danger cancel-btn" onclick="location.href='${pageContext.request.contextPath}/community/admin/adminBoardList.do'">취소</button>
