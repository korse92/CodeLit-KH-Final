...
<sec:authorize access="isAuthenticated()">
  <div class="container">
        ...
        <div class="mt-5">
	      ...
	      <sec:authorize access="hasRole('ADMIN') && !hasAnyRole('TEACHER', 'USER')">
	  		<div class="community-footer mt-5">
	        	<button class="btn btn-primary pull-right board-write" onclick="location.href='${pageContext.request.contextPath}/community/noticeWrite.do'">글쓰기</button>		       
	      	</div>
         </sec:authorize>
      </div>
     </div>
