			...
			<div class="row p-5">
				...
				<c:if test="${empty list}">
						...
						<h6 style="text-align: center;">
							<a href="${pageContext.request.contextPath}">메인으로 돌아가기</a></h6>
				</c:if>
						...
						<div class="card position-relative text-decoration-none text-dark"
							...
							<div class="card-body">
								...
								<c:forEach var="i" begin="1" end="5">
									<i class="${i <= result.lecAssessment ? 'fas' : 'far'} fa-star text-warning"></i>
								</c:forEach>
								</p>
								...
								<div class="row my-2">
									<div class="col-auto">
										<c:forEach items="${categoryList}" var="category">
											<c:if test="${category.no eq result.refLecCatNo}">
												<h4>${category.name}</h4>
											</c:if>
										</c:forEach>
									</div>
