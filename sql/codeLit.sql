...
DROP TABLE "LEC_STREAMING_SESSION";
...
ALTER TABLE "STUDY_BOARD" ADD CONSTRAINT "FK_LECTURE_TO_STUDY_BOARD_1" FOREIGN KEY (
	"REF_LECTURE_NO"
)
REFERENCES "LECTURE" (
	"LECTURE_NO"
...
ALTER TABLE "COUNSELING_CHAT" ADD CONSTRAINT "FK_MEMBER_TO_COUNSELING_CHAT_1" FOREIGN KEY (
	"SENDER_ID"
)
REFERENCES "MEMBER" (
	"MEMBER_ID"
...
ALTER TABLE "COUNSELING_CHAT" ADD CONSTRAINT "FK_MEMBER_TO_COUNSELING_CHAT_2" FOREIGN KEY (
	"RECEIVER_ID"
)
REFERENCES "MEMBER" (
	"MEMBER_ID"
...
ALTER TABLE "LECTURE_PART" ADD CONSTRAINT "FK_LECTURE_TO_LECTURE_PART_1" FOREIGN KEY (
	"REF_LECTURE_NO"
)
REFERENCES "LECTURE" (
	"LECTURE_NO"
...
ALTER TABLE "LECTURE_COMMENT" ADD CONSTRAINT "FK_LECTURE_TO_LECTURE_COMMENT_1" FOREIGN KEY (
	"REF_LECTURE_NO"
)
REFERENCES "LECTURE" (
	"LECTURE_NO"
...
ALTER TABLE "LECTURE_COMMENT" ADD CONSTRAINT "FK_MEMBER_TO_LECTURE_COMMENT_1" FOREIGN KEY (
	"REF_MEMBER_ID"
)
REFERENCES "MEMBER" (
	"MEMBER_ID"
...
ALTER TABLE "LECTURE_CLICK" ADD CONSTRAINT "FK_LECTURE_TO_LECTURE_CLICK_1" FOREIGN KEY (
	"REF_LECTURE_NO"
)
REFERENCES "LECTURE" (
	"LECTURE_NO"
...
ALTER TABLE "LECTURE_CLICK" ADD CONSTRAINT "FK_MEMBER_TO_LECTURE_CLICK_1" FOREIGN KEY (
	"REF_MEMBER_ID"
)
REFERENCES "MEMBER" (
	"MEMBER_ID"
...
ALTER TABLE "LECTURE_PROGRESS" ADD CONSTRAINT "FK_MEMBER_TO_LECTURE_PROGRESS_1" FOREIGN KEY (
	"REF_MEMBER_ID"
)
REFERENCES "MEMBER" (
	"MEMBER_ID"
...
ALTER TABLE "LECTURE_PROGRESS" ADD CONSTRAINT "FK_LECTURE_TO_LECTURE_PROGRESS_1" FOREIGN KEY (
	"REF_LECTURE_NO"
)
REFERENCES "LECTURE" (
	"LECTURE_NO"
...
ALTER TABLE "LECTURE_PROGRESS" ADD CONSTRAINT "FK_LECTURE_CHAPTER_TO_LECTURE_PROGRESS_1" FOREIGN KEY (
	"REF_LEC_CHAPTER_NO"
)
...
ALTER TABLE "TEACHER" ADD CONSTRAINT "FK_LECTURE_CATEGORY_TO_TEACHER_1" FOREIGN KEY (
	"REF_LEC_CAT_NO"
)
REFERENCES "LECTURE_CATEGORY" (
	"LEC_CAT_NO"
...
ALTER TABLE "ATTACHMENT" ADD CONSTRAINT "FK_CONTENTS_GROUP_TO_ATTACHMENT_1" FOREIGN KEY (
...
ALTER TABLE "LECTURE_CHAPTER" ADD CONSTRAINT "FK_LECTURE_PART_TO_LECTURE_CHAPTER_1" FOREIGN KEY (
	"REF_LEC_PART_NO"
)
...
ALTER TABLE "STREAMING_DATE" ADD CONSTRAINT "FK_LECTURE_TO_STREAMING_DATE_1" FOREIGN KEY (
	"REF_LECTURE_NO"
)
REFERENCES "LECTURE" (
	"LECTURE_NO"
...
ALTER TABLE "LEC_STREAMING_SESSION" ADD CONSTRAINT "FK_LECTURE_TO_LEC_STREAMING_SESSION_1" FOREIGN KEY (
	"LECTURE_NO"
)
REFERENCES "LECTURE" (
	"LECTURE_NO"
